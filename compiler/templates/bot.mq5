...
input string MT5_ID       = "{{MT5_ID}}";
input string EXPIRY       = "{{EXPIRY}}";
input string PLAN         = "{{PLAN}}";
input string LICENSE_UUID = "{{LICENSE_UUID}}";
input string API_BASE_URL = "{{API_BASE_URL}}";
